...
SRC			 			=	ms_main.c	ms_signals.c	ms_utils_free.c	ms_utils_print.c	ms_utils_pars_arg.c		ms_utils_libft.c\
							...
							builtins/ft_strncmpbuil.c \
              				parsing/parsing.c parsing/parsarg.c	parsing/parsopt.c 	parsing/parsfile.c	parsing/parsheredoc.c	parsing/pars.c	parsing/parsvar.c\
